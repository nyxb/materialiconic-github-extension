const githubConfig = {
   ...
   replaceIcon: (svgEl, newSVG) => {
      ...
      // https://github.com/nyxblabs/materialiconic-github-extension/pull/66
      else {
